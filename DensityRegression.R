...
colnames(RegDF)
m1 <- glm(N ~ scale(HumanAct) ,family=Gamma(link="log"), data=RegDF)
check_model(m1)
summary(m1)
m2 <- glm(N ~ scale(distherb) ,family=Gamma(link="log"), data=RegDF)
check_model(m2)
summary(m2)
m3 <- glm(N ~ scale(LengthGrid) ,family=Gamma(link="log"), data=RegDF)
check_model(m3)
summary(m3)
m4 <- glm(N ~ scale(Length150) ,family=Gamma(link="log"), data=RegDF)
check_model(m4)
summary(m4)
m5 <- glm(N ~ scale(lc100.Forest) ,family=Gamma(link="log"), data=RegDF)
check_model(m5)
summary(m5)
m6 <- glm(N ~ scale(lc250.Forest) ,family=Gamma(link="log"), data=RegDF)
check_model(m6)
summary(m6)
m7 <- glm(N ~ scale(lc385.Forest) ,family=Gamma(link="log"), data=RegDF)
check_model(m7)
summary(m7)
m8 <- glm(N ~ scale(lc100.Shrub) ,family=Gamma(link="log"), data=RegDF)
check_model(m8)
summary(m8)
m9 <- glm(N ~ scale(lc250.Shrub) ,family=Gamma(link="log"), data=RegDF)
check_model(m9)
summary(m9)
m10 <- glm(N ~ scale(lc385.Shrub) ,family=Gamma(link="log"), data=RegDF)
check_model(m10)
summary(m10)
m11 <- glm(N ~ scale(slope) ,family=Gamma(link="log"), data=RegDF)
check_model(m11)
summary(m11)
m12 <- glm(N ~ scale(LengthGrid) * scale(HumanAct) ,family=Gamma(link="log"), data=RegDF)
check_model(m12)
summary(m12)
m13 <- glm(N ~ scale(LengthGrid) + scale(HumanAct) + scale(distherb) ,family=Gamma(link="log"), data=RegDF)
check_model(m13)
summary(m13)
m14 <- glm(N ~ scale(LengthGrid) + scale(HumanAct) + scale(slope) ,family=Gamma(link="log"), data=RegDF)
check_model(m14)
summary(m14)
m15 <- glm(N ~ scale(HumanAct) + scale(slope) ,family=Gamma(link="log"), data=RegDF)
check_model(m15)
summary(m15)
m16 <- glm(N ~ scale(LengthGrid) + scale(slope) ,family=Gamma(link="log"), data=RegDF)
check_model(m16)
summary(m16)
m17 <- glm(N ~ scale(lc250.Shrub) * scale(HumanAct) ,family=Gamma(link="log"), data=RegDF)
check_model(m17)
summary(m17)
m18 <- glm(N ~ scale(HumanAct) + scale(LengthGrid) ,family=Gamma(link="log"), data=RegDF)
check_model(m18)
summary(m18)
m19 <- glm(N ~ scale(slope100) ,family=Gamma(link="log"), data=RegDF)
check_model(m19)
summary(m19)
##############################################################
...
#model selection
TempList <- list("Distance to Herbaceous"=m2,"Human Activity"=m1,"Trail Density (Grid)"=m3,"Trail Density (Grid) * Human Activity"=m12,"Trail Density (Grid) + Human Activity + Distance to Herbaceous"=m13,"Trail Density (Grid) + Human Activity + Slope"=m14,"Human Activity + Slope"=m15,"Trail Density (Grid) + Slope"=m16,"Shrub (100m) + Human Activity"=m17,"Human Activity + Trail Density (Grid)"=m18,"Slope (100m)"=m19)
aictab(TempList)
AIC <- aictab(TempList)
